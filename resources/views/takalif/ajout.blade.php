...
@section('content')
    ...
    <div class="col-md-9 ajout">
      <div class="card">
        <div class="card-body">   
          <FORm  action="{{ route ('takalif.store') }}" method="post" >
              @csrf
    {{ csrf_field() }}
...
<div class="row mb-3">
  ...
  <div class="col-sm-8">
    <input name="N_Tak" type="number" value="{{ old('N_Tak') }}" class="form-control" id="inputN_Tak">
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-8">
        <input name="Date_Tak" type="date" value="{{ old('Date_Tak') }}" class="form-control" id="inputDate_Tak">
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-8">
        <input name="Typ_Tak"  value="{{ old('Typ_Tak') }}" type="text"   class="form-control" id="inputTyp_Tak">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-8">
          <input name="Doti" type="text"  value="{{ old('Doti') }}" class="form-control" id="inputDoti">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-8">
        <select name="Mat_En" required ="true" value="{{ old('Mat_En') }}" id="inputState" class="form-select" >
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-8">
        <input name="Et_Fon1" type="text" value="{{ old('Et_Fon1') }}" class="form-control" id="inputEt_Fon1">
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-8">
        <input name="Pr_Et1" type="text" value="{{ old('Pr_Et1') }}" class="form-control" id="inputPr_Et1">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-8">
          <input name="NbHEt1" type="number" value="{{ old('NbHEt1') }}" class="form-control" id="inputNbHEt1">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-8">
          <input name="Obj_Tak1" type="text" value="{{ old('Obj_Tak1') }}" class="form-control" id="inputObj_Tak1">
